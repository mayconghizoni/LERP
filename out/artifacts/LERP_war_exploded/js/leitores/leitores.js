            ...
            for (var i = 0; i < listaLeitores.length; i++) {
                ...
                if(listaLeitores[i].status == 1){
                    leitor += "<div class=\"card livros\">" +
                        ...
                        "<p class=\"card-text\"> ID: #"+ listaLeitores[i].id + "</p>" +
                        "<p class=\"card-text\"> Fone: "  + listaLeitores[i].fone + "</p>" +
                        "<button type=\"button\" href=\"#\" class=\"btn btn-margin btn-outline-primary\">Visualizar</button>" +
